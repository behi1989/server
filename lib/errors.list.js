...
let orderVerficationFailed = new Error("Order Verification needs both transaction id and address");
orderVerficationFailed.status = 403;
...
let invalidTicket = new Error('invalid ticket');
invalidTicket.status = 404;
...
let campaignIsExprired = new Error('campaign is already expired');
campaignIsExprired.statusCode = 500;
