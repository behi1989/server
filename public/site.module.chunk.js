...
/***/ "../../../../../src/app/shared/components/collection-header/collection-header.component.css":
...
/***/ "../../../../../src/app/shared/components/collection-header/collection-header.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"second-bar\">\r\n  <div class=\"persian-mode-logo\" [routerLink]=\"['/']\">پرشین مد<span>ُ</span></div>\r\n  <ul>\r\n    <li *ngFor=\"let item of topMenu\" [class.selected]=\"selected[item.collectionName]\"\r\n        (mouseenter)=\"showList(item.type)\" (mouseleave)=\"countDownHideList()\">\r\n      <a [routerLink]=\"item.routerLink\">{{item.info.text}}</a>\r\n    </li>\r\n  </ul>\r\n  <div class=\"search-bar\" [style.borderColor]=\"searchIsFocused ? 'black' : '#E5E5E5'\"\r\n       [style.width]=\"(searchIsFocused ? 247 : 197) + 'px'\">\r\n    <i class=\"fa fa-search fa-flip-horizontal\"></i>\r\n    <input placeholder=\"جُست‌وجو\" type=\"text\" (focus)=\"searchFocused()\" (blur)=\"searchUnfocused()\"\r\n           [style.width]=\"(searchIsFocused ? 206 : 156) + 'px'\">\r\n  </div>\r\n</div>\r\n<div class=\"genderList\" [class.hidden]=\"hiddenGenderMenu\" (mouseenter)=\"persistList()\" (mouseleave)=\"hideList()\">\r\n  <div class=\"genderListWrapper\">\r\n    <div *ngIf=\"menu && menu.headerList\" class=\"headerList\">\r\n      <ul>\r\n        <li *ngFor=\"let item of menu.headerList\"><a [routerLink]=\"item.routerLink\">{{item.text}}</a></li>\r\n      </ul>\r\n    </div>\r\n    <div *ngIf=\"menu && menu.middleList\" class=\"middle\">\r\n      <ul *ngFor=\"let list of menu.middleList\">\r\n        <li *ngFor=\"let item of list;first as isFirst\" [class.headerItem]=\"isFirst || item.isHeader\"\r\n            [style.marginTop]=\"(!isFirst && item.isHeader ? 15 : 0 )+ 'px'\"><a [routerLink]=\"item.routerLink\">{{item.text}}</a>\r\n        </li>\r\n      </ul>\r\n    </div>\r\n    <div *ngIf=\"menu && menu.leftList\" class=\"leftColumn\">\r\n      <ul *ngFor=\"let list of menu.leftList\">\r\n        <li *ngFor=\"let item of list;first as isFirst\" [class.headerItem]=\"isFirst\"><a [routerLink]=\"item.routerLink\">{{item.text}}</a>\r\n        </li>\r\n      </ul>\r\n    </div>\r\n  </div>\r\n</div>\r\n"

/***/ }),

/***/ "../../../../../src/app/shared/components/collection-header/collection-header.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CollectionHeaderComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_placement_service__ = __webpack_require__("../../../../../src/app/shared/services/placement.service.ts");
...
var CollectionHeaderComponent = /** @class */ (function () {
    function CollectionHeaderComponent(router, placementService) {
        this.router = router;
    ...
    CollectionHeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.placementService.placement$.filter(function (r) { return r[0] === 'menu'; }).map(function (r) { return r[1]; }).subscribe(function (data) {
            _this.topMenu = data.filter(function (r) { return r.variable_name === 'topMenu'; });
            _this.topMenu.forEach(function (r) {
                r.routerLink = ['/'].concat(r.info.href.split('/'));
                r.type = r.routerLink[2];
            });
            var subMenu = data.filter(function (r) { return r.variable_name === 'subMenu'; });
            var sections = Array.from(new Set(subMenu.map(function (r) { return r.info.section; })));
            _this.placements = {};
            sections.forEach(function (s) {
                subMenu
                    .filter(function (r) { return r.info.section === s; })
                    .sort(function (x, y) { return (x.info.column * 100 + x.info.row) - (y.info.column * 100 + y.info.row); })
                    .forEach(function (r) {
                    var path = r.info.section.split('/');
                    r.info.routerLink = ['/'].concat(r.info.href.split('/'));
                    if (!_this.placements[path[0] + 'Menu']) {
                        _this.placements[path[0] + 'Menu'] = {};
                    }
                    if (!_this.placements[path[0] + 'Menu'][path[1] + 'List']) {
                        _this.placements[path[0] + 'Menu'][path[1] + 'List'] = [];
                    }
                    if (r.info.column > 1 &&
                        (!_this.placements[path[0] + 'Menu'][path[1] + 'List'][r.info.column - 1] ||
                            !_this.placements[path[0] + 'Menu'][path[1] + 'List'][r.info.column - 1].length)) {
                        if (r.info.column === 2) {
                            var temp_1 = [];
                            _this.placements[path[0] + 'Menu'][path[1] + 'List'].forEach(function (x) { return temp_1.push(x); });
                            _this.placements[path[0] + 'Menu'][path[1] + 'List'] = [];
                            _this.placements[path[0] + 'Menu'][path[1] + 'List'].push(temp_1);
                        }
                        _this.placements[path[0] + 'Menu'][path[1] + 'List'].push([]);
                    }
                    if (r.info.column > 1) {
                        _this.placements[path[0] + 'Menu'][path[1] + 'List'][r.info.column - 1].push(r.info);
                    }
                    else {
                        _this.placements[path[0] + 'Menu'][path[1] + 'List'].push(r.info);
                    }
                });
            });
        });
    };
    CollectionHeaderComponent.prototype.showList = function (type) {
        var _this = this;
        setTimeout(function () {
            _this.hiddenGenderMenu = false;
            _this.selected[type] = true;
            _this.menu = _this.placements[type + 'Menu'];
        }, 100);
    };
    CollectionHeaderComponent.prototype.countDownHideList = function () {
        var _this = this;
        setTimeout(function () {
            if (!_this.persistedList) {
                _this.hideList();
            }
        }, 100);
    };
    CollectionHeaderComponent.prototype.searchFocused = function () {
        this.searchIsFocused = true;
    };
    CollectionHeaderComponent.prototype.searchUnfocused = function () {
        this.searchIsFocused = false;
    };
    CollectionHeaderComponent.prototype.persistList = function () {
        this.persistedList = true;
    };
    CollectionHeaderComponent.prototype.hideList = function () {
        this.hiddenGenderMenu = true;
        this.persistedList = false;
    ...
    CollectionHeaderComponent.prototype.goToRoot = function () {
        this.router.navigate(['']);
    };
    CollectionHeaderComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-collection-header',
            template: __webpack_require__("../../../../../src/app/shared/components/collection-header/collection-header.component.html"),
            styles: [__webpack_require__("../../../../../src/app/shared/components/collection-header/collection-header.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["g" /* Router */], __WEBPACK_IMPORTED_MODULE_2__services_placement_service__["a" /* PlacementService */]])
    ], CollectionHeaderComponent);
    return CollectionHeaderComponent;
}());
...
/***/ "../../../../../src/app/shared/components/gen-dialog/gen-dialog.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/shared/components/gen-dialog/gen-dialog.component.html":
/***/ (function(module, exports) {

module.exports = "<div>\r\n  <app-login *ngIf=\"componentName === dialogEnum.login\" (closeDialog)=\"close()\"></app-login>\r\n  <app-register *ngIf=\"componentName === dialogEnum.register\" (closeDialog)=\"close()\"></app-register>\r\n  <app-other-details *ngIf=\"componentName === dialogEnum.oauthOtherDetails\" (closeDialog)=\"close()\" [status]=\"extraData.status\"></app-other-details>\r\n</div>\r\n"

/***/ }),

/***/ "../../../../../src/app/shared/components/gen-dialog/gen-dialog.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GenDialogComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_material__ = __webpack_require__("../../../material/esm5/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__enum_dialog_components_enum__ = __webpack_require__("../../../../../src/app/shared/enum/dialog.components.enum.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GenDialogComponent = /** @class */ (function () {
    function GenDialogComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.componentName = null;
        this.dialogEnum = __WEBPACK_IMPORTED_MODULE_2__enum_dialog_components_enum__["a" /* DialogEnum */];
        this.extraData = {};
    }
    GenDialogComponent.prototype.ngOnInit = function () {
        this.componentName = this.data.componentName;
        this.extraData = this.data.extraData ? this.data.extraData : {};
    };
    GenDialogComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    GenDialogComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-gen-dialog',
            template: __webpack_require__("../../../../../src/app/shared/components/gen-dialog/gen-dialog.component.html"),
            styles: [__webpack_require__("../../../../../src/app/shared/components/gen-dialog/gen-dialog.component.css")]
        }),
...
module.exports = "<nav class=\"first-bar\">\r\n  <ul>\r\n    <li *ngFor=\"let logo of logos\" [ngStyle]=\"{width: (logo.width ? logo.width + 'px' : 'initial')}\">\r\n      <a href=\"#\" class=\"gnav-member-bar\" [title]=\"logo.brand\">\r\n        <img\r\n          src=\"assets/logos/{{logo.filename}}\" class=\"general\"\r\n          [ngStyle]=\"{top: (logo.top ? -logo.top : 0)+ 'px', right: (logo.right ? -logo.right : 0) + 'px', height: (logo.height ? logo.height : 29) + 'px'}\"></a>\r\n    </li>\r\n  </ul>\r\n  <ul class=\"right-bar\">\r\n    <li><a href=\"#\" class=\"faWrapper\" aria-label=\"Shopping Bag\"><i\r\n      class=\"fa fa-shopping-bag fa-flip-horizontal\"></i></a>\r\n    <li *ngIf=\"!isLoggedIn || !isVerified\">\r\n      <a (click)=\"login()\" class=\"faWrapper clickable-link\" aria-label=\"Sign In or Register\"><i\r\n        class=\"fa fa-sign-in fa-flip-horizontal loginIcon\"></i></a>\r\n    </li>\r\n    <li *ngIf=\"isLoggedIn && isVerified\">\r\n      <a (click)=\"logout()\" class=\"faWrapper clickable-link\" aria-label=\"Sign Out\"><i\r\n        class=\"fa fa-sign-out loginIcon\"></i></a>\r\n    </li>\r\n  </ul>\r\n</nav>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_material__ = __webpack_require__("../../../material/esm5/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gen_dialog_gen_dialog_component__ = __webpack_require__("../../../../../src/app/shared/components/gen-dialog/gen-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__enum_dialog_components_enum__ = __webpack_require__("../../../../../src/app/shared/enum/dialog.components.enum.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_placement_service__ = __webpack_require__("../../../../../src/app/shared/services/placement.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_router__ = __webpack_require__("../../../router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_window_service__ = __webpack_require__("../../../../../src/app/shared/services/window.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(dialog, authService, placementService, router, window) {
        this.dialog = dialog;
        ...
        this.window = window;
        this.logos = [];
        this.dialogEnum = __WEBPACK_IMPORTED_MODULE_3__enum_dialog_components_enum__["a" /* DialogEnum */];
        this.isLoggedIn = false;
        this.isVerified = false;
    }
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.isLoggedIn.subscribe(function (data) { return _this.isLoggedIn = data; }, function (err) {
            console.error('Cannot subscribe on isLoggedIn: ', err);
            _this.isLoggedIn = false;
        });
        this.authService.isVerified.subscribe(function (data) { return _this.isVerified = data; }, function (err) {
            console.error('Cannot subscribe on isVerified: ', err);
            _this.isVerified = false;
        });
        this.placementService.placement$.filter(function (r) { return r[0] === 'logos'; }).map(function (r) { return r[1]; }).subscribe(function (data) {
            _this.logos = [];
            data = data.sort(function (x, y) { return x.column - y.column; });
            data.forEach(function (r) {
                ...
                if (r.info.style) {
                    ['width', 'height', 'top', 'right'].forEach(function (key) {
                        if (r.info.style[key])
                            obj[key] = r.info.style[key];
                    });
                }
                _this.logos.push(obj);
            });
        });
    };
    HeaderComponent.prototype.login = function () {
        ...
        this.authService.checkValidation(this.router.url)
            .then(function () {
            _this.authService.isVerified.subscribe(function (data) {
                if (!data && _this.window.innerWidth >= 960)
                    _this.dialog.open(__WEBPACK_IMPORTED_MODULE_2__gen_dialog_gen_dialog_component__["a" /* GenDialogComponent */], {
                        width: '500px',
                        data: {
                            componentName: _this.dialogEnum.oauthOtherDetails,
                            extraData: {
                                status: 'verify',
                            }
                        }
            ...
            _this.dialog.open(__WEBPACK_IMPORTED_MODULE_2__gen_dialog_gen_dialog_component__["a" /* GenDialogComponent */], {
                width: '500px',
                data: {
                    componentName: _this.dialogEnum.login,
                }
            });
        });
    };
    ...
    HeaderComponent = __decorate([
        ...
        __param(4, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_7__services_window_service__["a" /* WINDOW */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_material__["f" /* MatDialog */], __WEBPACK_IMPORTED_MODULE_4__services_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_5__services_placement_service__["a" /* PlacementService */], __WEBPACK_IMPORTED_MODULE_6__angular_router__["g" /* Router */], Object])
    ], HeaderComponent);
...
/***/ "../../../../../src/app/shared/components/mobile-header/mobile-header.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_window_service__ = __webpack_require__("../../../../../src/app/shared/services/window.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MobileHeaderComponent = /** @class */ (function () {
    function MobileHeaderComponent(authService, router, window) {
        this.authService = authService;
        this.router = router;
        this.window = window;
        this.menuWidth = 100;
    ...
    MobileHeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.isLoggedIn.subscribe(function (data) { return _this.isLoggedIn = data; }, function (err) { return console.error('Cannot subscribe to isloggedIn: ', err); });
        this.authService.isVerified.subscribe(function (data) { return _this.isVerified = data; }, function (err) { return console.error('Cannot subscribe to isVerified: ', err); });
    };
    MobileHeaderComponent.prototype.getKeys = function (object) {
        var temp = object ? Object.keys(object) : [];
        return temp;
    };
    MobileHeaderComponent.prototype.select = function (targetLevel, object, title) {
    ...
    MobileHeaderComponent.prototype.back = function (targetLevel) {
        if (targetLevel === 1) {
            this.isFirstLevel = true;
            this.isSecondLevel = false;
            this.isThirdLevel = false;
    ...
    MobileHeaderComponent.prototype.backDropClick = function (data) {
        this.isFirstLevel = true;
        this.isSecondLevel = false;
        this.isThirdLevel = false;
        this.sideNav.toggle();
    };
    MobileHeaderComponent.prototype.authentication = function () {
        var _this = this;
        this.authService.checkValidation(this.router.url)
            .then(function () {
            _this.authService.isVerified.subscribe(function (data) {
                if (!data && _this.window.innerWidth < 960)
                    _this.router.navigate(['login/oauth/other/verify']);
            });
        })
            .catch(function (err) {
    ...
    MobileHeaderComponent.prototype.logout = function () {
        this.authService.logout();
    ...
    ], MobileHeaderComponent.prototype, "sideNav", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], MobileHeaderComponent.prototype, "menuWidth", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], MobileHeaderComponent.prototype, "menuHeight", void 0);
    MobileHeaderComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-mobile-header',
            template: __webpack_require__("../../../../../src/app/shared/components/mobile-header/mobile-header.component.html"),
            styles: [__webpack_require__("../../../../../src/app/shared/components/mobile-header/mobile-header.component.css")]
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_3__services_window_service__["a" /* WINDOW */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["g" /* Router */], Object])
...
/***/ "../../../../../src/app/shared/components/sliding-header/sliding-header.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/shared/components/sliding-header/sliding-header.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"chevron-holder left-chevron\"><i *ngIf=\"curSlideIndex !== slides.length - 1\" class=\"fa fa-chevron-left\"\r\n                                            (click)=\"nextSlide()\"></i></div>\r\n<div class=\"chevron-holder right-chevron\"><i *ngIf=\"!!curSlideIndex\" class=\"fa fa-chevron-right\"\r\n                                             (click)=\"prevSlide()\"></i></div>\r\n<div class=\"carousel-slider\">\r\n\r\n  <div [style.width]=\"slides.length * 100 + '%'\" [style.right]=\"-curSlideIndex * 100 +'%'\">\r\n    <span *ngFor=\"let slide of slides\" [style.width]=\"(100 / slides.length).toPrecision(4) + '%'\"><img\r\n      [style.width]=\"slide.imgWidth? slide.imgWidth + 'px': '40px'\" [style.marginLeft]=\"slide.imgMarginLeft ? slide.imgMarginLeft + 'px' : 0\"\r\n      src=\"{{slide.imgAddr}}\"/> {{slide.text}}</span>\r\n  </div>\r\n</div>\r\n"

/***/ }),

/***/ "../../../../../src/app/shared/components/sliding-header/sliding-header.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SlidingHeaderComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_placement_service__ = __webpack_require__("../../../../../src/app/shared/services/placement.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SlidingHeaderComponent = /** @class */ (function () {
    function SlidingHeaderComponent(placementService) {
        this.placementService = placementService;
        this.curSlideIndex = 0;
        this.slides = [];
    }
    SlidingHeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.placementService.placement$.filter(function (r) { return r[0] === 'slider'; }).map(function (r) { return r[1]; }).subscribe(function (data) {
            for (var i = 0; i < data.length; i++) {
                _this.slides.push({});
                _this.slides[i].text = data[i].variable_name;
                _this.slides[i].imgAddr = data[i].info.imgUrl;
                for (var key in defaultStyle) {
                    if (defaultStyle.hasOwnProperty(key)) {
                        _this.slides[i][key] = data[i].info.style && data[i].info.style[key] ? data[i].info.style[key] : defaultStyle[key];
                    }
                }
                _this.slides[i].href = data[i].info.href;
            }
            console.log(_this.slides);
        });
        this.initSlider();
    };
    SlidingHeaderComponent.prototype.ngOnDestroy = function () {
        clearInterval(this.slider);
    };
    SlidingHeaderComponent.prototype.initSlider = function () {
        var _this = this;
        clearInterval(this.slider);
        this.slider = setInterval(function () { return _this.curSlideIndex = (_this.curSlideIndex + 1) % _this.slides.length; }, 5000);
    };
    SlidingHeaderComponent.prototype.nextSlide = function () {
        this.curSlideIndex++;
        this.initSlider();
    };
    SlidingHeaderComponent.prototype.prevSlide = function () {
        this.curSlideIndex--;
        this.initSlider();
    };
    SlidingHeaderComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-sliding-header',
            template: __webpack_require__("../../../../../src/app/shared/components/sliding-header/sliding-header.component.html"),
            styles: [__webpack_require__("../../../../../src/app/shared/components/sliding-header/sliding-header.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_placement_service__["a" /* PlacementService */]])
    ], SlidingHeaderComponent);
    return SlidingHeaderComponent;
}());
...
/***/ "../../../../../src/app/shared/enum/dialog.components.enum.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DialogEnum; });
var DialogEnum;
(function (DialogEnum) {
    DialogEnum[DialogEnum["register"] = 0] = "register";
    DialogEnum[DialogEnum["login"] = 1] = "login";
    DialogEnum[DialogEnum["oauthOtherDetails"] = 2] = "oauthOtherDetails";
...
/***/ "../../../../../src/app/site/login/components/login/login.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".persian-mode-center-logo {\r\n  font-family: nastaliq !Important;\r\n  font-size: 30px;\r\n  display: inline-block;\r\n  color: black;\r\n  -webkit-transition: all .3s ease-in;\r\n  transition: all .3s ease-in;\r\n}\r\n\r\n.persian-mode-center-logo span {\r\n  top: -20px;\r\n  right: -16px;\r\n  position: relative;\r\n  font-size: 80%;\r\n}\r\n\r\n.join-link {\r\n  margin-top: 15px;\r\n  font-size: 0.8em;\r\n}\r\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_components_gen_dialog_gen_dialog_component__ = __webpack_require__("../../../../../src/app/shared/components/gen-dialog/gen-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_enum_dialog_components_enum__ = __webpack_require__("../../../../../src/app/shared/enum/dialog.components.enum.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, router, window, dialog) {
        this.authService = authService;
        this.router = router;
        this.window = window;
        this.dialog = dialog;
        this.closeDialog = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.dialogEnum = __WEBPACK_IMPORTED_MODULE_7__shared_enum_dialog_components_enum__["a" /* DialogEnum */];
        this.seen = {};
        this.curFocus = null;
    }
    ...
    LoginComponent.prototype.goToRegister = function () {
        if (this.window.innerWidth >= 960) {
            ...
            this.dialog.open(__WEBPACK_IMPORTED_MODULE_6__shared_components_gen_dialog_gen_dialog_component__["a" /* GenDialogComponent */], {
                width: '500px',
                data: {
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], LoginComponent.prototype, "closeDialog", void 0);
    LoginComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-login',
            template: __webpack_require__("../../../../../src/app/site/login/components/login/login.component.html"),
            styles: [__webpack_require__("../../../../../src/app/site/login/components/login/login.component.css")]
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_4__shared_services_window_service__["a" /* WINDOW */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__shared_services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["g" /* Router */], Object, __WEBPACK_IMPORTED_MODULE_5__angular_material__["f" /* MatDialog */]])
    ], LoginComponent);
...
/***/ "../../../../../src/app/site/login/components/oauth-handler/oauth-handler.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/site/login/components/oauth-handler/oauth-handler.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/site/login/components/oauth-handler/oauth-handler.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return OauthHandlerComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_components_gen_dialog_gen_dialog_component__ = __webpack_require__("../../../../../src/app/shared/components/gen-dialog/gen-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_enum_dialog_components_enum__ = __webpack_require__("../../../../../src/app/shared/enum/dialog.components.enum.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OauthHandlerComponent = /** @class */ (function () {
    function OauthHandlerComponent(authService, router, window, dialog) {
        this.authService = authService;
        this.router = router;
        this.window = window;
        this.dialog = dialog;
        this.dialogEnum = __WEBPACK_IMPORTED_MODULE_6__shared_enum_dialog_components_enum__["a" /* DialogEnum */];
    }
    OauthHandlerComponent.prototype.ngOnInit = function () {
        ...
        this.authService.checkValidation(this.router.url)
            ...
            _this.authService.isVerified.subscribe(function (data) {
                _this.router.navigate(['/home']);
                if (!data) {
                    _this.dialog.open(__WEBPACK_IMPORTED_MODULE_5__shared_components_gen_dialog_gen_dialog_component__["a" /* GenDialogComponent */], {
                        width: '500px',
                        data: {
                            componentName: _this.dialogEnum.oauthOtherDetails,
                        }
            ...
            .catch(function (err) {
            if (_this.window.innerWidth >= 960)
                _this.dialog.open(__WEBPACK_IMPORTED_MODULE_5__shared_components_gen_dialog_gen_dialog_component__["a" /* GenDialogComponent */], {
                    width: '500px',
                    data: {
                        componentName: _this.dialogEnum.login,
    ...
    OauthHandlerComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("../../../../../src/app/site/login/components/oauth-handler/oauth-handler.component.html"),
            styles: [__webpack_require__("../../../../../src/app/site/login/components/oauth-handler/oauth-handler.component.css")]
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_3__shared_services_window_service__["a" /* WINDOW */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["g" /* Router */], Object, __WEBPACK_IMPORTED_MODULE_4__angular_material__["f" /* MatDialog */]])
...
/***/ "../../../../../src/app/site/login/components/other-details/other-details.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".box-center {\r\n  width: unset;\r\n}\r\n\r\n.box-center input{\r\n  text-align: center;\r\n}\r\n", ""]);
...
var StatusEnum;
(function (StatusEnum) {
    StatusEnum[StatusEnum["details"] = 0] = "details";
    StatusEnum[StatusEnum["verify"] = 1] = "verify";
})(StatusEnum || (StatusEnum = {}));
var OtherDetailsComponent = /** @class */ (function () {
    function OtherDetailsComponent(httpService, authService, route, router) {
        ...
        this.curStatus = StatusEnum.details;
        this.mobile_no = null;
        this.mobileHasError = false;
        this.code = null;
    }
    Object.defineProperty(OtherDetailsComponent.prototype, "status", {
        set: function (value) {
    ...
    OtherDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            if (params['status'] && params['status'].toLowerCase() === 'verify')
                _this.curStatus = _this.statusEnum.verify;
            else
                _this.curStatus = _this.statusEnum.details;
        });
    };
    OtherDetailsComponent.prototype.addMobileNumber = function () {
        var _this = this;
    ...
    OtherDetailsComponent.prototype.checkCode = function () {
        var _this = this;
        this.httpService.post('register/verify', {
            username: this.authService.userDetails.username,
            code: this.code,
        }).subscribe(function (data) {
            _this.authService.isVerified.next(true);
            _this.closeDialog.emit(true);
            _this.router.navigate(['home']);
        }, function (err) {
    ...
    OtherDetailsComponent.prototype.resendCode = function () {
    ...
    OtherDetailsComponent.prototype.checkMobilePattern = function () {
        if ((/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/).test(this.mobile_no))
            this.mobileHasError = false;
        else
            this.mobileHasError = true;
    };
    OtherDetailsComponent.prototype.logout = function () {
        this.authService.logout();
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
    ], OtherDetailsComponent.prototype, "closeDialog", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], OtherDetailsComponent.prototype, "status", null);
    OtherDetailsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-other-details',
            template: __webpack_require__("../../../../../src/app/site/login/components/other-details/other-details.component.html"),
            styles: [__webpack_require__("../../../../../src/app/site/login/components/other-details/other-details.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_services_http_service__["a" /* HttpService */], __WEBPACK_IMPORTED_MODULE_2__shared_services_auth_service__["a" /* AuthService */],
...
/***/ "../../../../../src/app/site/register/components/register/register.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__("../../../forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jalali_moment__ = __webpack_require__("../../../../jalali-moment/jalali-moment.js");
...
var RegStatus;
(function (RegStatus) {
    RegStatus["Register"] = "Register";
    RegStatus["Verify"] = "Verify";
})(RegStatus || (RegStatus = {}));
;
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(httpService, authService) {
        this.httpService = httpService;
        this.authService = authService;
        this.closeDialog = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        ...
        this.curStatus = RegStatus.Register;
        this.code = null;
    }
    RegisterComponent.prototype.ngOnInit = function () {
        this.dateObject = __WEBPACK_IMPORTED_MODULE_2_jalali_moment__(new Date()).format('jYYYY,jMM,jDD');
        this.initForm();
    };
    RegisterComponent.prototype.initForm = function () {
        this.registerForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormBuilder"]().group({
            username: [null, [
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required,
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].email,
                ]],
            ...
            mobile_no: [null, [
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required,
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].pattern(/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/),
                ]],
        });
    };
    RegisterComponent.prototype.setGender = function (g) {
        this.gender = g;
        this.seen['gender'] = true;
    };
    RegisterComponent.prototype.setSeen = function (item) {
        this.seen[item] = true;
        this.curFocus = item;
    };
    RegisterComponent.prototype.register = function () {
        ...
        if (this.registerForm.valid && this.gender) {
            var data_1 = {};
            Object.keys(this.registerForm.controls).forEach(function (el) { return data_1[el] = _this.registerForm.controls[el].value; });
            data_1['gender'] = this.gender;
            this.httpService.put('register', data_1).subscribe(function (res) {
                _this.curStatus = _this.regStatus.Verify;
            }, function (err) {
                console.error('Cannot register user: ', err);
            });
        }
        else {
            Object.keys(this.registerForm.controls).forEach(function (el) {
                if (!_this.registerForm.controls[el].valid) {
                    _this.seen[el] = true;
                }
            });
            if (!this.gender) {
    ...
    RegisterComponent.prototype.resendCode = function () {
        this.httpService.post('register/resend', {
    ...
    RegisterComponent.prototype.backToRegister = function () {
        this.curStatus = this.regStatus.Register;
    };
    RegisterComponent.prototype.checkCode = function () {
        var _this = this;
        this.httpService.post('register/verify', {
            code: this.code,
            username: this.registerForm.controls['username'].value,
        }).subscribe(function (data) {
            _this.authService.login(_this.registerForm.controls['username'].value, _this.registerForm.controls['password'].value)
                .then(function (res) {
                _this.closeDialog.emit(true);
            })
                .catch(function (err) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
    ], RegisterComponent.prototype, "closeDialog", void 0);
    RegisterComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-register',
            template: __webpack_require__("../../../../../src/app/site/register/components/register/register.component.html"),
            styles: [__webpack_require__("../../../../../src/app/site/register/components/register/register.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__shared_services_http_service__["a" /* HttpService */], __WEBPACK_IMPORTED_MODULE_4__shared_services_auth_service__["a" /* AuthService */]])
    ], RegisterComponent);
...
module.exports = " <div *ngIf=\"curWidth >= 960\">\r\n  <div class=\"fixed\">\r\n    <app-header></app-header>\r\n    <app-collection-header></app-collection-header>\r\n  </div>\r\n  <div class=\"scrollable\">\r\n    <app-sliding-header></app-sliding-header>\r\n    <div class=\"content\">\r\n      <router-outlet></router-outlet>\r\n      <app-footer></app-footer>\r\n    </div>\r\n  </div>\r\n</div>\r\n<div *ngIf=\"curWidth < 960\">\r\n  <div class=\"fixed\">\r\n    <app-mobile-header [menuWidth]=\"curWidth - 40\" [menuHeight]=\"curHeight\"></app-mobile-header>\r\n  </div>\r\n  <div class=\"mobile-content\">\r\n    <router-outlet></router-outlet>\r\n  </div>\r\n  <app-footer></app-footer>\r\n</div>\r\n"
...
var SiteComponent = /** @class */ (function () {
    function SiteComponent(window, authService, router) {
        this.window = window;
        this.authService = authService;
        this.router = router;
        this.curWidth = 100;
    ...
    SiteComponent.prototype.onResize = function (event) {
    ...
    ], SiteComponent.prototype, "onResize", null);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__site_routing__ = __webpack_require__("../../../../../src/app/site/site.routing.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_components_header_header_component__ = __webpack_require__("../../../../../src/app/shared/components/header/header.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_components_collection_header_collection_header_component__ = __webpack_require__("../../../../../src/app/shared/components/collection-header/collection-header.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_components_sliding_header_sliding_header_component__ = __webpack_require__("../../../../../src/app/shared/components/sliding-header/sliding-header.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_components_mobile_header_mobile_header_component__ = __webpack_require__("../../../../../src/app/shared/components/mobile-header/mobile-header.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ng2_jalali_date_picker__ = __webpack_require__("../../../../ng2-jalali-date-picker/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ng2_jalali_date_picker___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_ng2_jalali_date_picker__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__shared_components_gen_dialog_gen_dialog_component__ = __webpack_require__("../../../../../src/app/shared/components/gen-dialog/gen-dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__login_components_login_login_component__ = __webpack_require__("../../../../../src/app/site/login/components/login/login.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__angular_forms__ = __webpack_require__("../../../forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__register_components_register_register_component__ = __webpack_require__("../../../../../src/app/site/register/components/register/register.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__login_components_oauth_handler_oauth_handler_component__ = __webpack_require__("../../../../../src/app/site/login/components/oauth-handler/oauth-handler.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__login_components_other_details_other_details_component__ = __webpack_require__("../../../../../src/app/site/login/components/other-details/other-details.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SiteModule = /** @class */ (function () {
    ...
    SiteModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__site_routing__["a" /* SiteRouting */],
                ...
                __WEBPACK_IMPORTED_MODULE_11_ng2_jalali_date_picker__["DpDatePickerModule"],
                __WEBPACK_IMPORTED_MODULE_17__shared_shared_module__["a" /* SharedModule */],
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__shared_components_header_header_component__["a" /* HeaderComponent */],
                __WEBPACK_IMPORTED_MODULE_5__shared_components_collection_header_collection_header_component__["a" /* CollectionHeaderComponent */],
                __WEBPACK_IMPORTED_MODULE_6__shared_components_sliding_header_sliding_header_component__["a" /* SlidingHeaderComponent */],
                __WEBPACK_IMPORTED_MODULE_9__shared_components_footer_footer_component__["a" /* FooterComponent */],
                __WEBPACK_IMPORTED_MODULE_7__shared_components_mobile_header_mobile_header_component__["a" /* MobileHeaderComponent */],
                __WEBPACK_IMPORTED_MODULE_3__site_component__["a" /* SiteComponent */],
                __WEBPACK_IMPORTED_MODULE_13__login_components_login_login_component__["a" /* LoginComponent */],
                __WEBPACK_IMPORTED_MODULE_16__login_components_oauth_handler_oauth_handler_component__["a" /* OauthHandlerComponent */],
                __WEBPACK_IMPORTED_MODULE_15__register_components_register_register_component__["a" /* RegisterComponent */],
                __WEBPACK_IMPORTED_MODULE_12__shared_components_gen_dialog_gen_dialog_component__["a" /* GenDialogComponent */],
                __WEBPACK_IMPORTED_MODULE_18__login_components_other_details_other_details_component__["a" /* OtherDetailsComponent */],
            ],
            entryComponents: [__WEBPACK_IMPORTED_MODULE_12__shared_components_gen_dialog_gen_dialog_component__["a" /* GenDialogComponent */]],
        })
    ], SiteModule);
    return SiteModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SiteRouting; });
/* unused harmony export SiteTestRouting */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login_components_login_login_component__ = __webpack_require__("../../../../../src/app/site/login/components/login/login.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__register_components_register_register_component__ = __webpack_require__("../../../../../src/app/site/register/components/register/register.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__login_components_oauth_handler_oauth_handler_component__ = __webpack_require__("../../../../../src/app/site/login/components/oauth-handler/oauth-handler.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__login_components_other_details_other_details_component__ = __webpack_require__("../../../../../src/app/site/login/components/other-details/other-details.component.ts");
...
var Site_ROUTES = [
    {
        path: '', component: __WEBPACK_IMPORTED_MODULE_2__site_component__["a" /* SiteComponent */], children: [
            ...
            { path: 'login', component: __WEBPACK_IMPORTED_MODULE_3__login_components_login_login_component__["a" /* LoginComponent */] },
            // {path: 'register', loadChildren: 'app/site/register/register.module#RegisterModule'},
            { path: 'register', component: __WEBPACK_IMPORTED_MODULE_4__register_components_register_register_component__["a" /* RegisterComponent */] },
            ...
            { path: 'login/oauth', component: __WEBPACK_IMPORTED_MODULE_5__login_components_oauth_handler_oauth_handler_component__["a" /* OauthHandlerComponent */] },
            { path: 'login/oauth/other/:status', component: __WEBPACK_IMPORTED_MODULE_6__login_components_other_details_other_details_component__["a" /* OtherDetailsComponent */] }
        ]
    }
];
var SiteRouting = __WEBPACK_IMPORTED_MODULE_0__angular_router__["h" /* RouterModule */].forChild(Site_ROUTES);
var SiteTestRouting = __WEBPACK_IMPORTED_MODULE_1__angular_router_testing__["a" /* RouterTestingModule */].withRoutes(Site_ROUTES);


/***/ }),

/***/ "../../../../jalali-moment/jalali-moment.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/calendar-nav/calendar-nav.component.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/common/services/dom-appender/dom-appender.service.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/common/services/utils/utils.service.js":
/***/ (function(module, exports, __webpack_require__) {

"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var calendar_value_enum_1 = __webpack_require__("../../../../ng2-jalali-date-picker/common/types/calendar-value-enum.js");
var core_1 = __webpack_require__("../../../core/esm5/core.js");
var moment = __webpack_require__("../../../../jalali-moment/jalali-moment.js");
var UtilsService = (function () {
    ...
    UtilsService.prototype.createValidator = function (_a, format, calendarType, locale) {
        ...
        if (minDate) {
            var md_1 = this.convertToMoment(minDate, format, locale);
            validators.push({
                key: 'minDate',
                isValid: function () {
        ...
        if (maxDate) {
            var md_2 = this.convertToMoment(maxDate, format, locale);
            validators.push({
                key: 'maxDate',
                isValid: function () {
        ...
        if (minTime) {
            var md_3 = this.onlyTime(this.convertToMoment(minTime, format, locale));
            validators.push({
                key: 'minTime',
                isValid: function () {
        ...
        if (maxTime) {
            var md_4 = this.onlyTime(this.convertToMoment(maxTime, format, locale));
            validators.push({
                key: 'maxTime',
                isValid: function () {
...
/***/ "../../../../ng2-jalali-date-picker/common/types/calendar-mode-enum.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/common/types/calendar-value-enum.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/date-picker.module.js":
/***/ (function(module, exports, __webpack_require__) {
...
var dom_appender_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/common/services/dom-appender/dom-appender.service.js");
var utils_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/common/services/utils/utils.service.js");
var date_picker_component_1 = __webpack_require__("../../../../ng2-jalali-date-picker/date-picker/date-picker.component.js");
var date_picker_directive_1 = __webpack_require__("../../../../ng2-jalali-date-picker/date-picker/date-picker.directive.js");
var day_calendar_component_1 = __webpack_require__("../../../../ng2-jalali-date-picker/day-calendar/day-calendar.component.js");
var month_calendar_component_1 = __webpack_require__("../../../../ng2-jalali-date-picker/month-calendar/month-calendar.component.js");
var time_select_component_1 = __webpack_require__("../../../../ng2-jalali-date-picker/time-select/time-select.component.js");
var calendar_nav_component_1 = __webpack_require__("../../../../ng2-jalali-date-picker/calendar-nav/calendar-nav.component.js");
var day_time_calendar_component_1 = __webpack_require__("../../../../ng2-jalali-date-picker/day-time-calendar/day-time-calendar.component.js");
var date_picker_component_2 = __webpack_require__("../../../../ng2-jalali-date-picker/date-picker/date-picker.component.js");
exports.DatePickerComponent = date_picker_component_2.DatePickerComponent;
var date_picker_directive_2 = __webpack_require__("../../../../ng2-jalali-date-picker/date-picker/date-picker.directive.js");
exports.DatePickerDirective = date_picker_directive_2.DatePickerDirective;
var day_calendar_component_2 = __webpack_require__("../../../../ng2-jalali-date-picker/day-calendar/day-calendar.component.js");
exports.DayCalendarComponent = day_calendar_component_2.DayCalendarComponent;
var day_time_calendar_component_2 = __webpack_require__("../../../../ng2-jalali-date-picker/day-time-calendar/day-time-calendar.component.js");
exports.DayTimeCalendarComponent = day_time_calendar_component_2.DayTimeCalendarComponent;
var time_select_component_2 = __webpack_require__("../../../../ng2-jalali-date-picker/time-select/time-select.component.js");
exports.TimeSelectComponent = time_select_component_2.TimeSelectComponent;
var month_calendar_component_2 = __webpack_require__("../../../../ng2-jalali-date-picker/month-calendar/month-calendar.component.js");
...
/***/ "../../../../ng2-jalali-date-picker/date-picker/date-picker-directive.service.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/date-picker/date-picker.component.js":
/***/ (function(module, exports, __webpack_require__) {
...
var dom_appender_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/common/services/dom-appender/dom-appender.service.js");
var utils_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/common/services/utils/utils.service.js");
var calendar_mode_enum_1 = __webpack_require__("../../../../ng2-jalali-date-picker/common/types/calendar-mode-enum.js");
var calendar_value_enum_1 = __webpack_require__("../../../../ng2-jalali-date-picker/common/types/calendar-value-enum.js");
var day_calendar_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/day-calendar/day-calendar.service.js");
var day_time_calendar_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/day-time-calendar/day-time-calendar.service.js");
var time_select_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/time-select/time-select.service.js");
var date_picker_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/date-picker/date-picker.service.js");
var core_1 = __webpack_require__("../../../core/esm5/core.js");
var forms_1 = __webpack_require__("../../../forms/esm5/forms.js");
var DatePickerComponent = (function () {
    ...
    Object.defineProperty(DatePickerComponent.prototype, "selected", {
        ...
        set: function (selected) {
            ...
            this.inputElementValue = this.utilsService
                .convertFromMomentArray(this.componentConfig.format, selected, calendar_value_enum_1.ECalendarValue.StringArr, this.componentConfig.locale)
                .join(', ');
    ...
    DatePickerComponent.prototype.changeLocale = function (locale) {
        this.dayCalendarConfig = __assign({}, this.dayCalendarConfig, { locale: locale });
        this.dayTimeCalendarConfig = __assign({}, this.dayTimeCalendarConfig, { locale: locale });
    };
    ...
    DatePickerComponent.decorators = [
        { type: core_1.Component, args: [{
                    ...
                    styles: ['dp-date-picker {  display: inline-block;}dp-date-picker.dp-material .dp-picker-input {  box-sizing: border-box;  height: 30px;  width: 252px;  font-size: 13px;  outline: none;}dp-date-picker .dp-input-container {  position: relative;}dp-date-picker .dp-selected {  background: rgba(16, 108, 200, 0.5);  color: #FFFFFF;}.dp-popup {  position: relative;  background: #FFFFFF;  box-shadow: 1px 1px 5px 0 rgba(0, 0, 0, 0.1);  border-left: 1px solid rgba(0, 0, 0, 0.1);  border-right: 1px solid rgba(0, 0, 0, 0.1);  border-bottom: 1px solid rgba(0, 0, 0, 0.1);  z-index: 9999;  white-space: nowrap;}'],
                    encapsulation: core_1.ViewEncapsulation.None,
                    providers: [
...
/***/ "../../../../ng2-jalali-date-picker/date-picker/date-picker.directive.js":
/***/ (function(module, exports, __webpack_require__) {

"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var date_picker_directive_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/date-picker/date-picker-directive.service.js");
var date_picker_component_1 = __webpack_require__("../../../../ng2-jalali-date-picker/date-picker/date-picker.component.js");
var core_1 = __webpack_require__("../../../core/esm5/core.js");
var forms_1 = __webpack_require__("../../../forms/esm5/forms.js");
...
/***/ "../../../../ng2-jalali-date-picker/date-picker/date-picker.service.js":
/***/ (function(module, exports, __webpack_require__) {
...
var DatePickerService = (function () {
    ...
    DatePickerService.prototype.getConfig = function (config, mode) {
        ...
        var _config = __assign({}, this.defaultConfig, ((config && config.locale && config.locale !== 'fa') ? this.gregorianExtensionConfig : {}), { format: this.getDefaultFormatByMode(mode, config) }, this.utilsService.clearUndefined(config));
...
/***/ "../../../../ng2-jalali-date-picker/day-calendar/day-calendar.component.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/day-calendar/day-calendar.service.js":
/***/ (function(module, exports, __webpack_require__) {
...
var DayCalendarService = (function () {
    ...
    DayCalendarService.prototype.getConfig = function (config) {
        var _config = __assign({}, this.DEFAULT_CONFIG, ((config && config.locale && config.locale !== 'fa') ? this.GREGORIAN_CONFIG_EXTENTION : {}), this.utilsService.clearUndefined(config));
        this.utilsService.convertPropsToMoment(_config, _config.format, ['min', 'max'], _config.locale);
        // moment.locale(_config.locale);
        return _config;
    };
    ...
    DayCalendarService.prototype.generateMonthArray = function (config, month, selected) {
        ...
        for (var i = 0; i < 8 && (firstDayOfBoard.day() !== firstDayOfWeekIndex); i++) {
    ...
    DayCalendarService.prototype.generateWeekdays = function (firstDayOfWeek, locale) {
        var weekdayNames = ['su', 'mo', 'tu', 'we', 'th', 'fr', 'sa'].reduce(function (acc, d, i) {
            var m = moment();
            m.locale(locale);
            m.day(i);
            acc[d] = m;
...
/***/ "../../../../ng2-jalali-date-picker/day-time-calendar/day-time-calendar.component.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/day-time-calendar/day-time-calendar.service.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
__export(__webpack_require__("../../../../ng2-jalali-date-picker/date-picker.module.js"));
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "../../../../ng2-jalali-date-picker/month-calendar/month-calendar.component.js":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("../../../core/esm5/core.js");
var month_calendar_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/month-calendar/month-calendar.service.js");
var moment = __webpack_require__("../../../../jalali-moment/jalali-moment.js");
var forms_1 = __webpack_require__("../../../forms/esm5/forms.js");
var utils_service_1 = __webpack_require__("../../../../ng2-jalali-date-picker/common/services/utils/utils.service.js");
...
/***/ "../../../../ng2-jalali-date-picker/month-calendar/month-calendar.service.js":
/***/ (function(module, exports, __webpack_require__) {
...
var MonthCalendarService = (function () {
    ...
    MonthCalendarService.prototype.getConfig = function (config) {
        var _config = __assign({}, this.DEFAULT_CONFIG, ((config && config.locale && config.locale !== 'fa') ? this.GREGORIAN_DEFAULT_CONFIG : {}), this.utilsService.clearUndefined(config));
        this.utilsService.convertPropsToMoment(_config, _config.format, ['min', 'max'], _config.locale);
        // moment.locale(_config.locale);
        return _config;
    };
...
/***/ "../../../../ng2-jalali-date-picker/time-select/time-select.component.js":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../ng2-jalali-date-picker/time-select/time-select.service.js":
/***/ (function(module, exports, __webpack_require__) {
